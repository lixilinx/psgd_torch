...
P**2 = F**(-1): Amari's natural gradient theory support this choice if F is close to the true Fisher matrix.

For this toy example, P**2 is better than P.
For many other tasks involving real word data, P might be better than P**2.
"""
...
for num_iter in range(10000):
    ...
    with torch.no_grad():
        ...
        pre_grads = [psgd.precond_grad_scaw(q[0], q[1], g) for (q, g) in zip(Qs, pre_grads)]# P*P*g: natural gradients using empirical Fisher
